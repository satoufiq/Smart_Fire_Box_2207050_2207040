...
| `Demonstration Video/` | Project demonstration video. |
| `Visuals/` | Supporting images and visual media. |
...
The demonstration video is available in the `Demonstration Video` folder, and supporting images are available in `Visuals`.
