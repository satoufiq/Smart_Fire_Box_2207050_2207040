...
This project was developed as an academic/educational Embedded System with IoT prototype. Feel free to use, modify, and build upon it for learning and non-commercial purposes.
